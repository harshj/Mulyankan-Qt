...
from system.data import get_data
from system.result import get_result, analyze
...
def evaluate(response_path , key_path , questions = "" , NO_OF_QUESTIONS = NO_OF_QUES):
    errors = []
    path = os.curdir + os.sep + "Results" + os.sep
